...
export const BRANDS = [
  ...
  "Axiom","Discmania","Discraft","Dynamic Discs","Gateway","Infinite Discs",
  "Innova","Kastaplast","Latitude 64","MVP","Prodigy","Streamline","Westside Discs",

  // (The rest — order however you like)
  "DGA","Clash Discs","Thought Space Athletics","Lone Star Discs","Mint Discs",
  "RPM Discs","Prodiscus","Divergent Discs","Disc Golf UK","Loft Discs",
  "Viking Discs","Birdie","Doombird (team)","Millennium","Kastaplast (Old Run)",
  "Alpha Discs","EV-7",
];

// How many from the top of BRANDS are “featured”
export const FEATURED_COUNT = 15;
export const FEATURED = BRANDS.slice(0, FEATURED_COUNT);

// Same suggestion logic, now using just BRANDS and FEATURED order.
export function computeBrandSuggestions(input, list = BRANDS, featuredCount = FEATURED_COUNT) {
